...
class Catalogue extends BaseController{
	...
	public function __construct(){
		$this->data = [];		
		$this->data['module'] = 'customer_catalogue';
	}

	public function index($page = 1){
		$session = session();
		$flag = $this->authentication->check_permission([
			'routes' => 'backend/customer/catalogue/index'
		]);
		...
		if($config['total_rows'] > 0){
			$config = pagination_config_bt(['url' => 'backend/customer/catalogue/index','perpage' => $perpage], $config);
			...
			$this->data['customerCatalogueList'] = $this->AutoloadModel->_get_where([
		...
		$this->data['template'] = 'backend/customer/catalogue/index';
	...
	public function create(){
		if($this->request->getMethod() == 'post'){
			...
			if ($this->validate($validate, $errorValidate)){
		 		...
		 		if($insertid > 0){
		 			...
		 			return redirect()->to(BASE_URL.'backend/customer/catalogue/index');
		 		}
	        }else{
		...
		$this->data['template'] = 'backend/customer/catalogue/store';
		return view('backend/dashboard/layout/home', $this->data);
	}
	...
	public function delete($id = 0){
		...
		$this->data['template'] = 'backend/customer/catalogue/delete';
		return view('backend/dashboard/layout/home', $this->data);
	}
