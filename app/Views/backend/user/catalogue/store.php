				...
				<div class="ibox m0">
					<div class="ibox-content">
						...
						<?php 
							...
							if($permission == '' && isset($user_catalogue['permission'])){
								...
								<div class="userGroupContainer clearfix">
									...
									<div class="i-checks">
										<label class="uk-flex uk-flex-middle">
											<input style="margin-top:0;margin-right:10px" name="permission[]" <?php echo (!empty($permission) && isset($permission) && in_array($valItem['param'], $permission)) ? 'checked' : '' ?> type="checkbox" value="<?php echo $valItem['param']; ?>">
