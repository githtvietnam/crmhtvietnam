...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý Nhân Sự</strong></li>
      </ol>
   </div>
</div>
                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li><a href="#" class="status" data-value="0" data-field="publish" data-module="user" title="Cập nhật trạng thái người dùng">Deactive Nhân Sự</a>
                            </li> 
                            <li><a href="#" class="status" data-value="1" data-field="publish" data-module="user" data-title="Cập nhật trạng thái người dùng">Active Nhân Sự</a>
                            </li>
                        </ul>
                        <a class="close-link">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/user/user/create') ?>" class="btn btn-danger btn-sm"><i class="fa fa-plus"></i> Thêm Nhân Sự mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
