...
<div class="row wrapper border-bottom white-bg page-heading">
   <div class="col-lg-8">
      ...
      <ol class="breadcrumb" style="margin-bottom:10px;">
         ...
         <li class="active"><strong>Quản lý VPS</strong></li>
      </ol>
   </div>
</div>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        ...
                        <div class="uk-flex uk-flex-middle uk-flex-space-between mb20">
                            ...
                            <div class="toolbox">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="uk-button">
                                        <a href="<?php echo base_url('backend/service/vps/create') ?>" class="btn btn-danger btn-sm open-window"><i class="fa fa-plus"></i> Thêm VPS mới</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example object-list">
                        ...
                        <tbody>
                            <?php if(isset($vpsCatalogueList) && is_array($vpsCatalogueList) && count($vpsCatalogueList)){ ?>
                            <?php foreach($vpsCatalogueList as $key => $val){ ?>
                            <?php  
                            ...
                            <tr id="post-<?php echo $val['id']; ?>" data-id="<?php echo $val['id']; ?>">
                                ...
                                <td class="text-success text-right"><?php echo $val['ip'] ?></td>
                                <td class="text-warning text-right"><?php echo $val['disk_space'] ?> GB</td>
                                <td class="text-right"><?php echo $val['creator'] ?></td>
                                <td class="text-right"><?php echo $val['created_at'] ?></td>
                                <td class="text-center">
                                    <a type="button" href="<?php echo base_url('backend/service/vps/update/'.$val['id']) ?>" class="btn btn-primary open-window"><i class="fa fa-edit"></i></a>
                                    <a type="button" href="<?php echo base_url('backend/service/vps/delete/'.$val['id']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php }}else{ ?>
                                <tr>
