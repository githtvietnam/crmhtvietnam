<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		<h2>Xóa Nhóm Thành Viên: <?php echo $customer_catalogue['title'] ?></h2>
		<ol class="breadcrumb">
			<li>
						...
						<div class="row mb15">
							<div class="col-lg-12">
								<div class="form-row">
									...
									<?php echo form_input('title', set_value('title', $customer_catalogue['title']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
									<?php echo form_hidden('id', set_value('id', $customer_catalogue['id']), 'class="form-control" disabled placeholder="" autocomplete="off"');?>
								</div>
							</div>
						</div>
